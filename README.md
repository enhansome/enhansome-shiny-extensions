...
[![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 495,055 | 🐛 100 | 📅 2026-06-30
...
* Inspired by: [awesome-react-components](https://github.com/brillout/awesome-react-components) ⭐ 48,174 | 🐛 76 | 📅 2026-01-26 and [awesome-rshiny](https://github.com/grabear/awesome-rshiny) ⭐ 868 | 🐛 7 | 🌐 R | 📅 2022-10-07.
...
* [shiny.fluent](https://github.com/Appsilon/shiny.fluent) ⭐ 292 | 🐛 44 | 🌐 R | 📅 2026-08-11 - Fluent UI for Shiny apps.
...
* [shinyGovstyle](https://github.com/dfe-analytical-services/shinyGovstyle) ⭐ 52 | 🐛 26 | 🌐 R | 📅 2026-08-11 - Custom GOV.UK style inputs for Shiny.
* [shiny.blueprint](https://github.com/Appsilon/shiny.blueprint) ⭐ 48 | 🐛 28 | 🌐 R | 📅 2026-08-12 - Palantir's Blueprint for Shiny apps.
...
* [muiMaterial](https://github.com/lgnbhl/muiMaterial) ⭐ 7 | 🐛 2 | 🌐 R | 📅 2026-08-04 - Material UI for Shiny apps and Quarto.
* [fomantic.plus](https://github.com/ashbaldry/fomantic.plus) ⭐ 7 | 🐛 0 | 🌐 R | 📅 2022-01-27 - Extra Fomantic UI components for shiny.semantic.
* [shinyds](https://github.com/novica/shinyds) ⭐ 3 | 🐛 3 | 🌐 R | 📅 2026-07-19 - Shiny bindings for the Designsystemet component library.
* [shiny.webawesome](https://github.com/mbanand/shiny.webawesome) ⭐ 2 | 🐛 0 | 🌐 R | 📅 2026-04-23 - Web Awesome component library for Shiny.
* [shinyglass](https://github.com/ericrayanderson/shinyglass) ⭐ 1 | 🐛 1 | 🌐 R | 📅 2026-08-11 - Liquid Glass design themes for Shiny, adding translucent surfaces, backdrop blur, and system typography to Bootstrap components via bslib.
...
* [flexdashboard](https://github.com/rstudio/flexdashboard) ⭐ 845 | 🐛 84 | 🌐 JavaScript | 📅 2026-06-26 - R Markdown format for flexible dashboards.
...
* [semantic.dashboard](https://github.com/Appsilon/semantic.dashboard) ⭐ 257 | 🐛 15 | 🌐 R | 📅 2024-04-18 - Fomantic UI for Shiny dashboards.
...
* [bs4Dashkit](https://github.com/PrigasG/bs4Dashkit) ⭐ 0 | 🐛 0 | 🌐 R | 📅 2026-08-10 - Branding, theme application, and navigation utilities for bs4Dash dashboards.
...
* [bslib](https://github.com/rstudio/bslib) ⭐ 566 | 🐛 205 | 🌐 SCSS | 📅 2026-08-12 - Tools for theming Shiny and R Markdown from R via Bootstrap (3 or 4) Sass.
* [fresh](https://github.com/dreamRs/fresh) ⭐ 233 | 🐛 12 | 🌐 SCSS | 📅 2025-09-04 - Create fresh themes for use in shiny & shinydashboard applications and flexdashboard documents.
* [designer](https://github.com/ashbaldry/designer) ⭐ 153 | 🐛 6 | 🌐 JavaScript | 📅 2026-01-08 - Shiny UI prototype builder allowing drag and drop UI components before saving the equivalent R code.
* [gfonts](https://github.com/dreamRs/gfonts) ⭐ 115 | 🐛 2 | 🌐 R | 📅 2023-01-08 - Offline Google Fonts for Markdown and Shiny.
* [sass](https://github.com/rstudio/sass) ⭐ 102 | 🐛 22 | 🌐 C++ | 📅 2025-06-30 - Compile Sass for dynamic style sheets.
...
* [shinyWidgets](https://github.com/dreamRs/shinyWidgets) ⭐ 870 | 🐛 115 | 🌐 R | 📅 2026-07-06 - Bootstrap 3 custom widgets for Shiny (switches, checkboxes, sweet alerts, slider text, knob inputs, select pickers, search bar, dropdown buttons).
...
* [dockViewR](https://github.com/cynkra/dockViewR) ⭐ 33 | 🐛 24 | 🌐 R | 📅 2026-08-12 - Layout manager widget for R and Shiny apps.
...
* [inshiny](https://github.com/nicholasdavies/inshiny) ⭐ 9 | 🐛 0 | 🌐 R | 📅 2026-04-30 - Compact inline widgets for Shiny apps.
* [card.pro](https://github.com/oobianom/card.pro) ⭐ 7 | 🐛 0 | 🌐 R | 📅 2025-02-17 - Lightweight modern and responsive card component for Shiny.
* [glasstabs](https://github.com/PrigasG/glasstabs) ⭐ 2 | 🐛 0 | 🌐 R | 📅 2026-08-10 - Animated glass-style tabs and multi-select filter for Shiny.
...
* [waiter](https://github.com/JohnCoene/waiter) ⭐ 495 | 🐛 35 | 🌐 JavaScript | 📅 2026-08-11 - Splash loading screens for Shiny.
...
* [conductor](https://github.com/etiennebacher/conductor) ⭐ 40 | 🐛 5 | 🌐 R | 📅 2026-08-06 - Create guided tours in Shiny apps using Shepherd.js.
...
* [chattr](https://github.com/mlverse/chattr) ⭐ 248 | 🐛 24 | 🌐 R | 📅 2025-11-11 - Interact with large language models (LLMs) in RStudio through the R console or Shiny gadget.
* [querychat](https://github.com/posit-dev/querychat) ⭐ 209 | 🐛 27 | 🌐 Python | 📅 2026-08-04 - Filter and query data frames in Shiny using an LLM chat interface.
* [shinychat](https://github.com/posit-dev/shinychat) ⭐ 136 | 🐛 56 | 🌐 TypeScript | 📅 2026-08-13 - Chat UI component for Shiny.
...
* [gt](https://github.com/rstudio/gt) ⭐ 2,162 | 🐛 333 | 🌐 R | 📅 2026-08-03 - Generate information-rich, publication-quality tables.
* [gtsummary](https://github.com/ddsjoberg/gtsummary) ⭐ 1,207 | 🐛 20 | 🌐 R | 📅 2026-08-11 - Presentation-ready data summary and analytic result tables.
...
* [reactable](https://github.com/glin/reactable) ⭐ 676 | 🐛 161 | 🌐 JavaScript | 📅 2026-06-16 - Interactive data tables for R, based on the React Table library and made with reactR.
* [flextable](https://github.com/davidgohel/flextable) ⭐ 625 | 🐛 10 | 🌐 R | 📅 2026-08-05 - Create tables for reporting with format and layout control.
* [DT](https://github.com/rstudio/DT) ⭐ 621 | 🐛 207 | 🌐 JavaScript | 📅 2026-05-18 - R interface to the DataTables library.
* [rhandsontable](https://github.com/jrowen/rhandsontable) ⭐ 391 | 🐛 166 | 🌐 HTML | 📅 2024-07-23 - Create Excel-like editable tables in Shiny apps.
* [gtExtras](https://github.com/jthomasmock/gtExtras) ⭐ 222 | 🐛 28 | 🌐 R | 📅 2026-01-16 - Extending gt for beautiful HTML tables.
...
* [dataviewR](https://github.com/madhankumarnagaraji/dataviewR) ⭐ 19 | 🐛 16 | 🌐 R | 📅 2026-08-10 - Interactive data frame viewer with filtering, column selection, and code generation.
...
* [datasetviewer](https://github.com/vthanik/datasetviewer) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-23 - SAS Studio style dataset viewer with browser-side filtering, sorting, metadata inspection, CSV export, and DuckDB-WASM queries.
...
* [equatiomatic](https://github.com/datalorax/equatiomatic) ⭐ 626 | 🐛 27 | 🌐 R | 📅 2026-04-10 - Transform fitted statistical models into LaTeX equations, with Shiny output and render bindings.
...
* [animejs](https://github.com/long39ng/animejs) ⭐ 1 | 🐛 0 | 🌐 R | 📅 2026-07-25 - Low-level htmlwidget bindings to Anime.js for browser-native SVG and HTML animations.
...
* [reactRouter](https://github.com/lgnbhl/reactRouter) ⭐ 14 | 🐛 1 | 🌐 R | 📅 2026-05-10 - React Router for Shiny apps and Quarto.
...
* [htmlwidgets](https://github.com/ramnathv/htmlwidgets) ⭐ 797 | 🐛 133 | 🌐 R | 📅 2026-04-22 - A framework for creating R bindings to JavaScript libraries.
* [shinyjs](https://github.com/daattali/shinyjs) ⭐ 751 | 🐛 5 | 🌐 R | 📅 2026-08-11 - Perform common JavaScript operations in Shiny apps.
* [crosstalk](https://github.com/rstudio/crosstalk) ⭐ 299 | 🐛 90 | 🌐 JavaScript | 📅 2025-08-27 - Inter-widget interactivity (for example, linked brushing and filtering) for htmlwidgets.
...
* [shinyscroll](https://github.com/JohnCoene/shinyscroll) ⭐ 22 | 🐛 1 | 🌐 R | 📅 2020-07-17 - Scroll to an element in Shiny.
* [pagemapR](https://github.com/swsoyee/pagemapR) ⭐ 21 | 🐛 0 | 🌐 R | 📅 2021-08-27 - Create a mini map for Shiny apps and R Markdown documents.
* [bscui](https://github.com/patzaw/bscui) ⭐ 20 | 🐛 0 | 🌐 R | 📅 2025-04-10 - Interactive SVG custom interfaces with Shiny bindings and proxy updates.
* [gotop](https://github.com/lgnbhl/gotop) ⭐ 17 | 🐛 1 | 🌐 R | 📅 2024-09-12 - Add a scroll back to top Font Awesome icon to Shiny apps and R Markdown documents using jQuery GoTop.
...
* [shinyphaser](https://github.com/maciekbanas/shinyphaser) ⭐ 4 | 🐛 22 | 🌐 R | 📅 2026-08-12 - Interface to the Phaser.js game framework for constructing and managing 2D games in Shiny apps.
...
* [plotly](https://github.com/plotly/plotly.R) ⭐ 2,675 | 🐛 758 | 🌐 R | 📅 2026-07-25 - Interactive web graphics via plotly.js. Has special support for linking/highlighting/filtering views.
* [ggiraph](https://github.com/davidgohel/ggiraph) ⭐ 875 | 🐛 9 | 🌐 R | 📅 2026-05-02 - HTML widget that makes ggplot2 graphics interactive. Select graphical elements, add tooltips, animations, and JavaScript actions to the graphics.
* [highcharter](https://github.com/jbkunst/highcharter) ⭐ 738 | 🐛 39 | 🌐 R | 📅 2026-04-26 - R wrapper for the highcharts JavaScript charting library.
* [echarts4r](https://github.com/JohnCoene/echarts4r) ⭐ 628 | 🐛 179 | 🌐 R | 📅 2026-06-23 - Interactive graphs with Echarts v4.
* [GWalkR](https://github.com/Kanaries/GWalkR) ⭐ 556 | 🐛 14 | 🌐 TypeScript | 📅 2025-07-03 - Interactive Tableau-like exploratory data analysis htmlwidget for Shiny.
* [r2d3](https://github.com/rstudio/r2d3) ⭐ 525 | 🐛 40 | 🌐 R | 📅 2024-01-09 - R interface to D3 visualizations.
* [googleVis](https://github.com/mages/googleVis) ⭐ 361 | 🐛 33 | 🌐 R | 📅 2025-10-08 - R interface to Google Charts.
* [canvasXpress](https://github.com/neuhausi/canvasXpress) ⭐ 312 | 🐛 27 | 🌐 R | 📅 2026-08-12 - Interactive visualization for scientific and biomedical research using CanvasXpress.
...
* [apexcharter](https://github.com/dreamRs/apexcharter) ⭐ 150 | 🐛 12 | 🌐 R | 📅 2026-08-06 - HTML widget for ApexCharts.js.
...
* [ggcube](https://github.com/matthewkling/ggcube) ⭐ 53 | 🐛 0 | 🌐 R | 📅 2026-07-29 - Create layered 3D figures with ggplot2, including drag-to-rotate htmlwidgets with Shiny output bindings.
...
* [c3](https://github.com/mrjoh3/c3) ⭐ 39 | 🐛 5 | 🌐 R | 📅 2021-07-04 - Interactive C3.js charts for R Markdown and Shiny applications.
...
* [AutoPlots](https://github.com/AdrianAntico/AutoPlots) ⭐ 25 | 🐛 0 | 🌐 R | 📅 2026-08-04 - High-level ECharts visualization helpers for common chart types and model evaluation plots.
...
* [myIO](https://github.com/mortonanalytics/myIO) ⭐ 7 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-09 - Composable D3 htmlwidget chart system.
* [controlcharts](https://github.com/aus-doh-safety-and-quality/controlcharts) ⭐ 5 | 🐛 4 | 🌐 JavaScript | 📅 2026-07-24 - Interactive funnel plots and statistical process control charts.
* [maidr](https://github.com/xability/r-maidr) ⭐ 4 | 🐛 10 | 🌐 HTML | 📅 2026-08-12 - Multimodal access and interactive data representation with accessibility features.
...
* [timevis](https://github.com/daattali/timevis) ⭐ 680 | 🐛 4 | 🌐 R | 📅 2024-08-18 - Interactive timeline visualizations based on vis.js.
...
* [nivo.bubblechart](https://github.com/DataRacerEdu/nivo.bubblechart) ⭐ 3 | 🐛 0 | 🌐 JavaScript | 📅 2026-01-14 - Nivo circle packing htmlwidget for hierarchical bubble charts in Shiny.
* [heattree](https://github.com/grunwaldlab/heattree) ⭐ 3 | 🐛 3 | 🌐 R | 📅 2026-05-08 - Interactive phylogenetic tree visualization.
* [muiTreeView](https://github.com/lgnbhl/muiTreeView) ⭐ 2 | 🐛 5 | 🌐 R | 📅 2026-08-07 - MUI X Tree View for Shiny apps and Quarto, a React component for navigating expandable, collapsible hierarchical lists.
...
* [visNetwork](https://github.com/datastorm-open/visNetwork) ⭐ 563 | 🐛 156 | 🌐 JavaScript | 📅 2026-07-15 - Network visualization using vis.js.
...
* [g6R](https://github.com/cynkra/g6R) ⭐ 31 | 🐛 10 | 🌐 R | 📅 2026-08-12 - Graph visualization engine widget based on AntV G6 for R and Shiny.
...
* [parcats](https://github.com/erblast/parcats) ⭐ 39 | 🐛 2 | 🌐 R | 📅 2025-09-04 - Interactive parallel categories diagrams using plotly.js.
...
* [DiagrammeR](https://github.com/rich-iannone/DiagrammeR) ⭐ 1,739 | 🐛 172 | 🌐 R | 📅 2026-04-27 - Diagram, graph, and network visualization based on D3.js, viz.js, and mermaid.js.
...
* [processmapR](https://github.com/bupaverse/processmapr) ⭐ 10 | 🐛 23 | 🌐 R | 📅 2026-02-27 - Construct interactive process maps using event data as htmlwidgets.
...
* [leaflet](https://github.com/rstudio/leaflet) ⭐ 840 | 🐛 319 | 🌐 JavaScript | 📅 2025-10-08 - R interface to the Leaflet JavaScript library to create interactive maps.
* [mapview](https://github.com/r-spatial/mapview) ⭐ 551 | 🐛 101 | 🌐 JavaScript | 📅 2025-09-05 - Interactive viewing of spatial data.
* [mapdeck](https://github.com/SymbolixAU/mapdeck) ⭐ 382 | 🐛 79 | 🌐 HTML | 📅 2025-03-21 - Interactive maps using Mapbox GL and Deck.gl.
...
* [mapgl](https://github.com/walkerke/mapgl) ⭐ 171 | 🐛 25 | 🌐 JavaScript | 📅 2026-08-07 - Interactive maps using Mapbox GL JS and MapLibre GL JS.
...
* [leaflet.extras2](https://github.com/trafficonese/leaflet.extras2) ⭐ 89 | 🐛 15 | 🌐 JavaScript | 📅 2025-10-13 - More plugins for the leaflet package.
...
* [leaflet.providers](https://github.com/rstudio/leaflet.providers) ⭐ 15 | 🐛 1 | 🌐 R | 📅 2026-03-19 - Third-party map tile provider definitions for the leaflet package.
...
* [toro](https://github.com/Epi-interactive-Ltd/toro) ⭐ 2 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-06 - Interactive and customizable maps using the MapLibre GL JS library.
...
* [geneviewer](https://github.com/nvelden/geneviewer) ⭐ 99 | 🐛 3 | 🌐 R | 📅 2025-09-29 - Interactive gene cluster visualization.
...
* [threeBrain](https://github.com/dipterix/threeBrain) ⭐ 50 | 🐛 0 | 🌐 R | 📅 2026-08-06 - Advanced 3D brain visualization as an htmlwidget.
...
* [ggseg3d](https://github.com/ggsegverse/ggseg3d) ⭐ 45 | 🐛 8 | 🌐 R | 📅 2026-08-07 - Interactive Three.js brain atlas meshes visualization.
* [igvShiny](https://github.com/gladkia/igvShiny) ⭐ 43 | 🐛 8 | 🌐 R | 📅 2026-08-12 - HTML widget for igv.js, a JavaScript library for embeddable genomic visualization.
* [JBrowseR](https://github.com/GMOD/JBrowseR) ⭐ 40 | 🐛 0 | 🌐 R | 📅 2026-08-12 - R interface to the JBrowse 2 linear genome view.
...
* [shiny.molstar](https://github.com/Appsilon/shiny.molstar) ⭐ 19 | 🐛 9 | 🌐 R | 📅 2026-08-12 - Shiny wrapper for Mol\*, a visualization toolkit of large scale molecular data.
...
* [safetyCharts](https://github.com/SafetyGraphics/safetyCharts) ⭐ 12 | 🐛 30 | 🌐 JavaScript | 📅 2025-04-09 - Charts for monitoring clinical trial safety.
...
* [msaR](https://github.com/zachcp/msaR) ⭐ 8 | 🐛 3 | 🌐 JavaScript | 📅 2021-09-22 - BioJS-based MSA (multiple sequence alignment) viewer.
...
* [jellyfisher](https://github.com/HautaniemiLab/jellyfisher) ⭐ 5 | 🐛 0 | 🌐 R | 📅 2025-11-26 - Interactive jellyfish plots combining sample and phylogenetic trees to visualize spatiotemporal tumor evolution.
...
* [rayshader](https://github.com/tylermorganwall/rayshader) ⭐ 2,174 | 🐛 48 | 🌐 R | 📅 2026-08-12 - Create and visualize hillshaded maps from elevation matrices.
* [rayrender](https://github.com/tylermorganwall/rayrender) ⭐ 643 | 🐛 4 | 🌐 C++ | 📅 2026-07-22 - Build and raytrace 3D scenes.
* [rgl](https://github.com/dmurdoch/rgl) ⭐ 102 | 🐛 20 | 🌐 C++ | 📅 2026-07-15 - Render WebGL scenes created with the rgl package ([vignette](https://cran.r-project.org/web/packages/rgl/vignettes/WebGL.html)).
...
* [Rhino](https://github.com/Appsilon/rhino) ⭐ 329 | 🐛 84 | 🌐 R | 📅 2026-06-10 - Build high quality, enterprise-grade Shiny apps at speed.
* [teal](https://github.com/insightsengineering/teal) ⭐ 263 | 🐛 74 | 🌐 R | 📅 2026-07-29 - Interactive exploration framework for analyzing clinical trials data, provides a dynamic filtering facility and different data viewers.
* [surveydown](https://github.com/surveydown-dev/surveydown) ⭐ 179 | 🐛 17 | 🌐 R | 📅 2026-06-23 - Markdown-based programmable surveys using Quarto and Shiny, with skip logic, multiple question types, and database storage.
* [yonder](https://github.com/nteetor/yonder) ⭐ 136 | 🐛 23 | 🌐 R | 📅 2026-08-13 - A reactive web framework built on Shiny with Bootstrap 4.
...
* [blockr.core](https://github.com/BristolMyersSquibb/blockr.core) ⭐ 16 | 🐛 22 | 🌐 R | 📅 2026-08-12 - Graphical web framework for data manipulation and visualization using reusable, composable blocks.
...
* [periscope2](https://github.com/Aggregate-Genius/periscope2) ⭐ 9 | 🐛 1 | 🌐 R | 📅 2026-08-05 - Enterprise streamlined Shiny application framework using bs4Dash.
...
* [teal.modules.clinical](https://github.com/insightsengineering/teal.modules.clinical) ⭐ 42 | 🐛 108 | 🌐 R | 📅 2026-08-09 - A set of teal modules for standard clinical outputs.
* [mwshiny](https://github.com/delosh653/mwshiny) ⭐ 25 | 🐛 2 | 🌐 R | 📅 2020-06-08 - Run a Shiny app across multiple connected browser windows.
* [teal.modules.general](https://github.com/insightsengineering/teal.modules.general) ⭐ 16 | 🐛 43 | 🌐 R | 📅 2026-08-12 - General modules for teal applications.
* [teal.code](https://github.com/insightsengineering/teal.code) ⭐ 12 | 🐛 13 | 🌐 R | 📅 2026-07-26 - Code storage and execution class for teal applications.
* [teal.slice](https://github.com/insightsengineering/teal.slice) ⭐ 12 | 🐛 34 | 🌐 R | 📅 2026-07-29 - Filter module for teal applications.
* [teal.data](https://github.com/insightsengineering/teal.data) ⭐ 11 | 🐛 18 | 🌐 R | 📅 2026-06-29 - Data model for teal applications.
* [teal.reporter](https://github.com/insightsengineering/teal.reporter) ⭐ 9 | 🐛 23 | 🌐 R | 📅 2026-07-27 - Reporting tools for Shiny modules.
...
* [teal.logger](https://github.com/insightsengineering/teal.logger) ⭐ 7 | 🐛 3 | 🌐 R | 📅 2026-06-29 - Logging setup for the teal family of packages.
* [tutorial.helpers](https://github.com/PPBDS/tutorial.helpers) ⭐ 7 | 🐛 0 | 🌐 HTML | 📅 2026-08-11 - Helper functions and Shiny modules for creating, editing, and testing tutorials with learnr, including collecting student submissions.
* [teal.widgets](https://github.com/insightsengineering/teal.widgets) ⭐ 6 | 🐛 35 | 🌐 R | 📅 2026-07-30 - Shiny widgets for teal applications.
...
* [teal.picks](https://github.com/insightsengineering/teal.picks) ⭐ 4 | 🐛 25 | 🌐 R | 📅 2026-08-12 - Dataset and variable picker and merge module for teal applications.
* [VizModules](https://github.com/j-andrews7/VizModules) ⭐ 3 | 🐛 16 | 🌐 R | 📅 2026-08-12 - Flexible Shiny plotting modules for composing interactive visualization apps.
* [teal.transform](https://github.com/insightsengineering/teal.transform) ⭐ 2 | 🐛 41 | 🌐 R | 📅 2026-06-29 - Functions and Shiny modules for extracting and merging data within the teal framework.
* [blockr.dplyr](https://github.com/BristolMyersSquibb/blockr.dplyr) ⭐ 1 | 🐛 1 | 🌐 R | 📅 2026-07-27 - Interactive dplyr data transformation blocks for blockr.
* [blockr.ggplot](https://github.com/BristolMyersSquibb/blockr.ggplot) ⭐ 1 | 🐛 4 | 🌐 R | 📅 2026-07-27 - Interactive ggplot2 visualization blocks for blockr.
* [blockr.io](https://github.com/BristolMyersSquibb/blockr.io) ⭐ 1 | 🐛 4 | 🌐 R | 📅 2026-08-03 - Interactive file import and export blocks for blockr.
* [blockr.dag](https://github.com/BristolMyersSquibb/blockr.dag) ⭐ 0 | 🐛 20 | 🌐 R | 📅 2026-08-12 - A directed acyclic graph extension for blockr.
* [blockr.dock](https://github.com/BristolMyersSquibb/blockr.dock) ⭐ 0 | 🐛 34 | 🌐 R | 📅 2026-08-12 - A docking layout manager for blockr.
* [blockr.session](https://github.com/BristolMyersSquibb/blockr.session) ⭐ 0 | 🐛 8 | 🌐 R | 📅 2026-08-12 - Persist, restore, share, and manage blockr boards with pins-backed storage, including Posit Connect user accounts and version history.
...
* [plumber](https://github.com/rstudio/plumber) ⭐ 1,437 | 🐛 126 | 🌐 R | 📅 2026-02-09 - Create web APIs by decorating R code with special comments.
* [opencpu](https://github.com/opencpu/opencpu) ⭐ 760 | 🐛 105 | 🌐 R | 📅 2026-05-31 - A system for embedded scientific computing and reproducible research with R.
* [RestRserve](https://github.com/rexyai/RestRserve) ⭐ 296 | 🐛 11 | 🌐 R | 📅 2025-03-21 - R web API framework for building high-performance and robust microservices and app backends.
...
* [plumber2](https://github.com/posit-dev/plumber2) ⭐ 116 | 🐛 28 | 🌐 R | 📅 2026-01-21 - Easy and powerful webservers in R. A complete rewrite of plumber.
* [htmxr](https://github.com/hyperverse-r/htmxr) ⭐ 44 | 🐛 0 | 🌐 R | 📅 2026-08-10 - Build server-driven web applications in R with htmx for partial page updates and plumber2 for non-blocking HTTP endpoints.
...
* [slackr](https://github.com/mrkaye97/slackr) ⭐ 308 | 🐛 5 | 🌐 R | 📅 2024-10-16 - Send messages, images, R objects, and files to Slack channels/users.
...
* [googlesheets4](https://github.com/tidyverse/googlesheets4) ⭐ 375 | 🐛 37 | 🌐 R | 📅 2026-08-12 - R interface to Google Sheets via the Sheets API v4.
* [googledrive](https://github.com/tidyverse/googledrive) ⭐ 345 | 🐛 41 | 🌐 R | 📅 2026-08-12 - R API client for Google Drive.
...
* [rsconnect](https://github.com/rstudio/rsconnect) ⭐ 145 | 🐛 72 | 🌐 R | 📅 2026-08-11 - Deploy Shiny apps to shinyapps.io, or Posit Connect.
...
* [webR](https://github.com/r-wasm/webr) ⭐ 1,086 | 🐛 91 | 🌐 TypeScript | 📅 2026-06-23 - A version of R compiled for the browser and Node.js using WebAssembly via Emscripten.
...
* [box](https://github.com/klmr/box) ⭐ 971 | 🐛 71 | 🌐 R | 📅 2026-05-29 - Organize code into hierarchical, composable, reusable modules, to use across projects.
...
* [reactlog](https://github.com/rstudio/reactlog) ⭐ 131 | 🐛 26 | 🌐 JavaScript | 📅 2026-05-18 - Visual debugger for Shiny reactivity.
...
* [jsplyr](https://github.com/r-world-devs/jsplyr) ⭐ 20 | 🐛 9 | 🌐 R | 📅 2026-07-17 - Dplyr backend for Shiny that lazily translates data wrangling verbs into client-side JavaScript and returns results asynchronously as promises.
...
* [renv](https://github.com/rstudio/renv) ⭐ 1,160 | 🐛 216 | 🌐 R | 📅 2026-08-11 - Create isolated, portable, and reproducible environments for R projects.
...
* [brand-yml](https://github.com/posit-dev/brand-yml) ⭐ 107 | 🐛 37 | 🌐 Python | 📅 2026-08-11 - Unified branding with `_brand.yml` files.
* [py-shinyswatch](https://github.com/posit-dev/py-shinyswatch) ⭐ 36 | 🐛 5 | 🌐 Python | 📅 2026-07-29 - Bootswatch themes for py-shiny.
...
* [py-htmltools](https://github.com/posit-dev/py-htmltools) ⭐ 24 | 🐛 29 | 🌐 Python | 📅 2026-05-21 - Tools for creating, manipulating, and writing HTML from Python.
...
* [shinychat](https://github.com/posit-dev/shinychat/tree/main/pkg-py) ⭐ 136 | 🐛 56 | 🌐 TypeScript | 📅 2026-08-13 - Chat UI component for Shiny for Python.
* [shinyrealtime](https://github.com/posit-dev/shinyrealtime) ⭐ 24 | 🐛 3 | 🌐 Python | 📅 2026-07-31 - Integrate OpenAI's Realtime API.

### Python - Table

* [great-tables](https://github.com/posit-dev/great-tables) ⭐ 2,715 | 🐛 105 | 🌐 Python | 📅 2026-08-12 - Create styled display tables in Python.
* [itables](https://github.com/mwouts/itables) ⭐ 969 | 🐛 40 | 🌐 Python | 📅 2026-08-07 - Display Pandas and Polars data frames as interactive DataTables that you can sort, paginate, scroll, and filter.
...
* [rsconnect-python](https://github.com/posit-dev/rsconnect-python) ⭐ 37 | 🐛 92 | 🌐 Python | 📅 2026-08-12 - CLI for interacting with and deploying to Posit Connect.
