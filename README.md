...
[![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 498,645 | 🐛 105 | 📅 2026-08-21
...
* Inspired by: [awesome-react-components](https://github.com/brillout/awesome-react-components) ⭐ 48,241 | 🐛 81 | 📅 2026-01-26 and [awesome-rshiny](https://github.com/grabear/awesome-rshiny) ⭐ 870 | 🐛 7 | 🌐 R | 📅 2022-10-07.
...
* [bslib](https://github.com/rstudio/bslib) ⭐ 568 | 🐛 206 | 🌐 SCSS | 📅 2026-08-21 - Tools for theming Shiny and R Markdown from R via Bootstrap (3 or 4) Sass.
...
* [querychat](https://github.com/posit-dev/querychat) ⭐ 211 | 🐛 28 | 🌐 Python | 📅 2026-08-21 - Filter and query data frames in Shiny using an LLM chat interface.
* [shinychat](https://github.com/posit-dev/shinychat) ⭐ 136 | 🐛 61 | 🌐 TypeScript | 📅 2026-08-21 - Chat UI component for Shiny.
...
* [gtsummary](https://github.com/ddsjoberg/gtsummary) ⭐ 1,207 | 🐛 18 | 🌐 R | 📅 2026-08-21 - Presentation-ready data summary and analytic result tables.
...
* [canvasXpress](https://github.com/neuhausi/canvasXpress) ⭐ 313 | 🐛 27 | 🌐 R | 📅 2026-08-21 - Interactive visualization for scientific and biomedical research using CanvasXpress.
...
* [maidr](https://github.com/xability/r-maidr) ⭐ 4 | 🐛 5 | 🌐 HTML | 📅 2026-08-21 - Multimodal access and interactive data representation with accessibility features.
...
* [muiTreeView](https://github.com/lgnbhl/muiTreeView) ⭐ 2 | 🐛 5 | 🌐 R | 📅 2026-08-21 - MUI X Tree View for Shiny apps and Quarto, a React component for navigating expandable, collapsible hierarchical lists.
...
* [mapview](https://github.com/r-spatial/mapview) ⭐ 552 | 🐛 101 | 🌐 JavaScript | 📅 2025-09-05 - Interactive viewing of spatial data.
...
* [igvShiny](https://github.com/gladkia/igvShiny) ⭐ 45 | 🐛 9 | 🌐 R | 📅 2026-08-21 - HTML widget for igv.js, a JavaScript library for embeddable genomic visualization.
...
* [yonder](https://github.com/nteetor/yonder) ⭐ 136 | 🐛 27 | 🌐 R | 📅 2026-08-21 - A reactive web framework built on Shiny with Bootstrap 4.
...
* [blockr.dplyr](https://github.com/BristolMyersSquibb/blockr.dplyr) ⭐ 1 | 🐛 1 | 🌐 R | 📅 2026-08-21 - Interactive dplyr data transformation blocks for blockr.
...
* [blockr.dock](https://github.com/BristolMyersSquibb/blockr.dock) ⭐ 0 | 🐛 31 | 🌐 R | 📅 2026-08-21 - A docking layout manager for blockr.
...
* [blastula](https://github.com/rstudio/blastula) ⭐ 577 | 🐛 107 | 🌐 R | 📅 2025-04-03 - Easily send HTML email messages from R.
...
* [googlesheets4](https://github.com/tidyverse/googlesheets4) ⭐ 375 | 🐛 37 | 🌐 R | 📅 2026-08-21 - R interface to Google Sheets via the Sheets API v4.
* [googledrive](https://github.com/tidyverse/googledrive) ⭐ 345 | 🐛 41 | 🌐 R | 📅 2026-08-21 - R API client for Google Drive.
...
* [renv](https://github.com/rstudio/renv) ⭐ 1,160 | 🐛 223 | 🌐 R | 📅 2026-08-21 - Create isolated, portable, and reproducible environments for R projects.
...
* [shinychat](https://github.com/posit-dev/shinychat/tree/main/pkg-py) ⭐ 136 | 🐛 61 | 🌐 TypeScript | 📅 2026-08-21 - Chat UI component for Shiny for Python.
* [shinyrealtime](https://github.com/posit-dev/shinyrealtime) ⭐ 25 | 🐛 3 | 🌐 Python | 📅 2026-07-31 - Integrate OpenAI's Realtime API.

### Python - Table

* [great-tables](https://github.com/posit-dev/great-tables) ⭐ 2,719 | 🐛 103 | 🌐 Python | 📅 2026-08-21 - Create styled display tables in Python.
...
* [rsconnect-python](https://github.com/posit-dev/rsconnect-python) ⭐ 37 | 🐛 97 | 🌐 Python | 📅 2026-08-20 - CLI for interacting with and deploying to Posit Connect.
