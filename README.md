...
[![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 504,867 | 🐛 106 | 📅 2026-09-02
...
* Inspired by: [awesome-react-components](https://github.com/brillout/awesome-react-components) ⭐ 48,380 | 🐛 91 | 📅 2026-01-26 and [awesome-rshiny](https://github.com/grabear/awesome-rshiny) ⭐ 870 | 🐛 7 | 🌐 R | 📅 2022-10-07.
...
* [shinyGovstyle](https://github.com/dfe-analytical-services/shinyGovstyle) ⭐ 52 | 🐛 22 | 🌐 R | 📅 2026-09-10 - Custom GOV.UK style inputs for Shiny.
...
* [dockViewR](https://github.com/cynkra/dockViewR) ⭐ 33 | 🐛 26 | 🌐 R | 📅 2026-09-10 - Layout manager widget for R and Shiny apps.
...
* [glasstabs](https://github.com/PrigasG/glasstabs) ⭐ 2 | 🐛 0 | 🌐 R | 📅 2026-09-07 - Animated glass-style tabs and multi-select filter for Shiny.
...
* [querychat](https://github.com/posit-dev/querychat) ⭐ 211 | 🐛 28 | 🌐 Python | 📅 2026-09-10 - Filter and query data frames in Shiny using an LLM chat interface.
...
* [gt](https://github.com/rstudio/gt) ⭐ 2,161 | 🐛 313 | 🌐 R | 📅 2026-09-09 - Generate information-rich, publication-quality tables.
...
* [esquisse](https://github.com/dreamRs/esquisse) ⭐ 1,861 | 🐛 53 | 🌐 R | 📅 2025-02-21 - Drag and drop inputs and visual builder for ggplot2.
...
* [shinygenui](https://github.com/nanxstats/shinygenui) ⭐ 1 | 🐛 0 | 🌐 R | 📅 2026-09-10 - Build and update Shiny interfaces through conversations with a large language model.
...
* [canvasXpress](https://github.com/neuhausi/canvasXpress) ⭐ 313 | 🐛 29 | 🌐 R | 📅 2026-09-10 - Interactive visualization for scientific and biomedical research using CanvasXpress.
...
* [maidr](https://github.com/xability/r-maidr) ⭐ 4 | 🐛 4 | 🌐 HTML | 📅 2026-09-07 - Multimodal access and interactive data representation with accessibility features.
...
* [rgexf](https://github.com/gvegayon/rgexf) ⭐ 32 | 🐛 10 | 🌐 JavaScript | 📅 2026-09-04 - Visualize GEXF files with sigma.js and gexf-js.
...
* [mapgl](https://github.com/walkerke/mapgl) ⭐ 173 | 🐛 26 | 🌐 R | 📅 2026-08-28 - Interactive maps using Mapbox GL JS and MapLibre GL JS.
...
* [geoarrowWidget](https://github.com/r-spatial/geoarrowWidget) ⭐ 7 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-10 - Attach GeoArrow and GeoParquet data to interactive htmlwidgets.
...
* [igvShiny](https://github.com/gladkia/igvShiny) ⭐ 46 | 🐛 6 | 🌐 R | 📅 2026-09-10 - HTML widget for igv.js, a JavaScript library for embeddable genomic visualization.
...
* [rayrender](https://github.com/tylermorganwall/rayrender) ⭐ 644 | 🐛 4 | 🌐 C++ | 📅 2026-09-10 - Build and raytrace 3D scenes.
...
* [teal](https://github.com/insightsengineering/teal) ⭐ 263 | 🐛 74 | 🌐 R | 📅 2026-09-10 - Interactive exploration framework for analyzing clinical trials data, provides a dynamic filtering facility and different data viewers.
...
* [teal.slice](https://github.com/insightsengineering/teal.slice) ⭐ 12 | 🐛 37 | 🌐 R | 📅 2026-09-10 - Filter module for teal applications.
* [teal.data](https://github.com/insightsengineering/teal.data) ⭐ 11 | 🐛 21 | 🌐 R | 📅 2026-09-10 - Data model for teal applications.
* [teal.reporter](https://github.com/insightsengineering/teal.reporter) ⭐ 9 | 🐛 27 | 🌐 R | 📅 2026-09-10 - Reporting tools for Shiny modules.
...
* [VizModules](https://github.com/j-andrews7/VizModules) ⭐ 3 | 🐛 15 | 🌐 R | 📅 2026-09-10 - Flexible Shiny plotting modules for composing interactive visualization apps.
...
* [blockr.dock](https://github.com/BristolMyersSquibb/blockr.dock) ⭐ 0 | 🐛 28 | 🌐 R | 📅 2026-09-10 - A docking layout manager for blockr.
...
* [shinyOAuth](https://github.com/lukakoning/shinyOAuth) ⭐ 28 | 🐛 2 | 🌐 R | 📅 2026-09-10 - Provider-agnostic OAuth authentication for Shiny applications.
...
* [googlesheets4](https://github.com/tidyverse/googlesheets4) ⭐ 377 | 🐛 37 | 🌐 R | 📅 2026-09-10 - R interface to Google Sheets via the Sheets API v4.
* [googledrive](https://github.com/tidyverse/googledrive) ⭐ 346 | 🐛 41 | 🌐 R | 📅 2026-09-10 - R API client for Google Drive.
...
* [great-tables](https://github.com/posit-dev/great-tables) ⭐ 2,726 | 🐛 104 | 🌐 Python | 📅 2026-09-10 - Create styled display tables in Python.
* [itables](https://github.com/mwouts/itables) ⭐ 976 | 🐛 43 | 🌐 Python | 📅 2026-09-10 - Display Pandas and Polars data frames as interactive DataTables that you can sort, paginate, scroll, and filter.
