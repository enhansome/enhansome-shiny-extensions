...
[![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 510,476 | 🐛 107 | 📅 2026-09-02
...
* [shidashi](https://github.com/dipterix/shidashi) ⭐ 11 | 🐛 2 | 🌐 R | 📅 2026-09-25 - A Shiny dashboard template system using AdminLTE 3 template.
...
* [gtExtras](https://github.com/jthomasmock/gtExtras) ⭐ 223 | 🐛 30 | 🌐 R | 📅 2026-01-16 - Extending gt for beautiful HTML tables.
...
* [rewind](https://github.com/tenmeh/rewind) ⭐ 4 | 🐛 0 | 🌐 R | 📅 2026-09-25 - Add user-facing undo and redo history for Shiny inputs and reactive state, with keyboard, button, and visual history controls.
...
* [canvasXpress](https://github.com/neuhausi/canvasXpress) ⭐ 315 | 🐛 2 | 🌐 R | 📅 2026-09-25 - Interactive visualization for scientific and biomedical research using CanvasXpress.
...
* [maidr](https://github.com/xability/r-maidr) ⭐ 4 | 🐛 2 | 🌐 HTML | 📅 2026-09-25 - Multimodal access and interactive data representation with accessibility features.
...
* [igvShiny](https://github.com/gladkia/igvShiny) ⭐ 46 | 🐛 6 | 🌐 R | 📅 2026-09-25 - HTML widget for igv.js, a JavaScript library for embeddable genomic visualization.
...
* [rayrender](https://github.com/tylermorganwall/rayrender) ⭐ 644 | 🐛 4 | 🌐 C++ | 📅 2026-09-25 - Build and raytrace 3D scenes.
...
* [blockr.dock](https://github.com/BristolMyersSquibb/blockr.dock) ⭐ 0 | 🐛 32 | 🌐 R | 📅 2026-09-25 - A docking layout manager for blockr.
...
* [googlesheets4](https://github.com/tidyverse/googlesheets4) ⭐ 378 | 🐛 37 | 🌐 R | 📅 2026-09-25 - R interface to Google Sheets via the Sheets API v4.
* [googledrive](https://github.com/tidyverse/googledrive) ⭐ 346 | 🐛 44 | 🌐 R | 📅 2026-09-25 - R API client for Google Drive.
...
* [py-shinywidgets](https://github.com/posit-dev/py-shinywidgets) ⭐ 54 | 🐛 41 | 🌐 Python | 📅 2026-05-06 - Render ipywidgets inside a Shiny app.
...
* [great-tables](https://github.com/posit-dev/great-tables) ⭐ 2,868 | 🐛 103 | 🌐 Python | 📅 2026-09-25 - Create styled display tables in Python.
