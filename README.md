...
[![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 508,265 | 🐛 106 | 📅 2026-09-02
...
* Inspired by: [awesome-react-components](https://github.com/brillout/awesome-react-components) ⭐ 48,456 | 🐛 92 | 📅 2026-01-26 and [awesome-rshiny](https://github.com/grabear/awesome-rshiny) ⭐ 870 | 🐛 7 | 🌐 R | 📅 2022-10-07.
...
* [shinyGovstyle](https://github.com/dfe-analytical-services/shinyGovstyle) ⭐ 52 | 🐛 15 | 🌐 R | 📅 2026-09-18 - Custom GOV.UK style inputs for Shiny.
* [shiny.blueprint](https://github.com/Appsilon/shiny.blueprint) ⭐ 48 | 🐛 28 | 🌐 R | 📅 2026-09-18 - Palantir's Blueprint for Shiny apps.
...
* [muiMaterial](https://github.com/lgnbhl/muiMaterial) ⭐ 7 | 🐛 2 | 🌐 R | 📅 2026-09-17 - Material UI for Shiny apps and Quarto.
...
* [shinyglass](https://github.com/ericrayanderson/shinyglass) ⭐ 2 | 🐛 0 | 🌐 R | 📅 2026-09-21 - Liquid Glass design themes for Shiny, adding translucent surfaces, backdrop blur, and system typography to Bootstrap components via bslib.
...
* [flexdashboard](https://github.com/rstudio/flexdashboard) ⭐ 848 | 🐛 84 | 🌐 JavaScript | 📅 2026-06-26 - R Markdown format for flexible dashboards.
...
* [bslib](https://github.com/rstudio/bslib) ⭐ 569 | 🐛 208 | 🌐 SCSS | 📅 2026-09-17 - Tools for theming Shiny and R Markdown from R via Bootstrap (3 or 4) Sass.
...
* [gdtools](https://github.com/davidgohel/gdtools) ⭐ 30 | 🐛 2 | 🌐 R | 📅 2026-06-06 - Embed Google Fonts and Liberation fonts in Shiny apps.
...
* [glasstabs](https://github.com/PrigasG/glasstabs) ⭐ 2 | 🐛 0 | 🌐 R | 📅 2026-09-20 - Animated glass-style tabs and multi-select filter for Shiny.
...
* [shinyfilters](https://github.com/joshwlivingston/shinyfilters) ⭐ 9 | 🐛 20 | 🌐 R | 📅 2026-09-19 - Create Shiny inputs from vectors, data frames, or any R object.
...
* [micromodal](https://github.com/kennedymwavu/micromodal) ⭐ 10 | 🐛 0 | 🌐 R | 📅 2026-07-09 - Simple modal dialogs for Shiny based on Micromodal.js.
...
* [shinychat](https://github.com/posit-dev/shinychat) ⭐ 139 | 🐛 62 | 🌐 TypeScript | 📅 2026-09-18 - Chat UI component for Shiny.
* [commons](https://github.com/posit-dev/commons) ⭐ 49 | 🐛 35 | 🌐 Python | 📅 2026-09-18 - Build data analysis agents backed by trusted calculations and searchable context, with server components for custom Shiny chat apps.
...
* [flextable](https://github.com/davidgohel/flextable) ⭐ 627 | 🐛 10 | 🌐 R | 📅 2026-09-10 - Create tables for reporting with format and layout control.
...
* [robservable](https://github.com/juba/robservable) ⭐ 166 | 🐛 7 | 🌐 HTML | 📅 2026-09-03 - [Observable](https://observablehq.com/) notebooks as R htmlwidgets.
...
* [rewind](https://github.com/tenmeh/rewind) ⭐ 4 | 🐛 0 | 🌐 R | 📅 2026-09-16 - Add user-facing undo and redo history for Shiny inputs and reactive state, with keyboard, button, and visual history controls.
...
* [shinygenui](https://github.com/nanxstats/shinygenui) ⭐ 4 | 🐛 0 | 🌐 R | 📅 2026-09-17 - Build and update Shiny interfaces through conversations with a large language model.
...
* [plotly](https://github.com/plotly/plotly.R) ⭐ 2,681 | 🐛 761 | 🌐 R | 📅 2026-07-25 - Interactive web graphics via plotly.js. Has special support for linking/highlighting/filtering views.
* [ggiraph](https://github.com/davidgohel/ggiraph) ⭐ 878 | 🐛 12 | 🌐 R | 📅 2026-08-14 - HTML widget that makes ggplot2 graphics interactive. Select graphical elements, add tooltips, animations, and JavaScript actions to the graphics.
...
* [echarts4r](https://github.com/JohnCoene/echarts4r) ⭐ 630 | 🐛 179 | 🌐 R | 📅 2026-06-23 - Interactive graphs with Echarts v4.
...
* [canvasXpress](https://github.com/neuhausi/canvasXpress) ⭐ 313 | 🐛 28 | 🌐 R | 📅 2026-09-20 - Interactive visualization for scientific and biomedical research using CanvasXpress.
...
* [apexcharter](https://github.com/dreamRs/apexcharter) ⭐ 150 | 🐛 12 | 🌐 R | 📅 2026-09-16 - HTML widget for ApexCharts.js.
...
* [myIO](https://github.com/mortonanalytics/myIO) ⭐ 7 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-19 - Composable D3 htmlwidget chart system.
...
* [maidr](https://github.com/xability/r-maidr) ⭐ 4 | 🐛 4 | 🌐 HTML | 📅 2026-09-19 - Multimodal access and interactive data representation with accessibility features.
...
* [trelliscopejs](https://github.com/hafen/trelliscopejs) ⭐ 264 | 🐛 77 | 🌐 R | 📅 2026-01-14 - Create interactive Trelliscope displays based on trelliscopejs-lib.
...
* [voronoiTreemap](https://github.com/uRosConf/voronoiTreemap) ⭐ 60 | 🐛 5 | 🌐 R | 📅 2019-07-02 - Interactive Voronoi treemaps as htmlwidgets.
...
* [muiTreeView](https://github.com/lgnbhl/muiTreeView) ⭐ 2 | 🐛 5 | 🌐 R | 📅 2026-09-18 - MUI X Tree View for Shiny apps and Quarto, a React component for navigating expandable, collapsible hierarchical lists.
...
* [DiagrammeR](https://github.com/rich-iannone/DiagrammeR) ⭐ 1,743 | 🐛 172 | 🌐 R | 📅 2026-04-27 - Diagram, graph, and network visualization based on D3.js, viz.js, and mermaid.js.
...
* [heatmaply](https://github.com/talgalili/heatmaply) ⭐ 410 | 🐛 39 | 🌐 R | 📅 2025-11-29 - Interactive heatmaps using plotly.
...
* [leaflet.extras](https://github.com/trafficonese/leaflet.extras) ⭐ 223 | 🐛 20 | 🌐 R | 📅 2026-09-17 - Extra functionality for the leaflet package.
...
* [mapgl](https://github.com/walkerke/mapgl) ⭐ 173 | 🐛 28 | 🌐 R | 📅 2026-09-11 - Interactive maps using Mapbox GL JS and MapLibre GL JS.
...
* [leaflet.extras2](https://github.com/trafficonese/leaflet.extras2) ⭐ 90 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-17 - More plugins for the leaflet package.
...
* [leaflegend](https://github.com/tomroh/leaflegend) ⭐ 38 | 🐛 0 | 🌐 R | 📅 2026-09-16 - Custom legends and symbols for leaflet maps.
...
* [geoarrowWidget](https://github.com/r-spatial/geoarrowWidget) ⭐ 9 | 🐛 1 | 🌐 R | 📅 2026-09-14 - Attach GeoArrow and GeoParquet data to interactive htmlwidgets.
...
* [explodemap](https://github.com/PrigasG/explodemap) ⭐ 0 | 🐛 1 | 🌐 HTML | 📅 2026-09-20 - Hierarchical exploded-view cartography with an interactive focus map widget for Shiny.
...
* [threeBrain](https://github.com/dipterix/threeBrain) ⭐ 52 | 🐛 0 | 🌐 R | 📅 2026-09-17 - Advanced 3D brain visualization as an htmlwidget.
...
* [JBrowseR](https://github.com/GMOD/JBrowseR) ⭐ 40 | 🐛 0 | 🌐 R | 📅 2026-09-16 - R interface to the JBrowse 2 linear genome view.
...
* [shiny.molstar](https://github.com/Appsilon/shiny.molstar) ⭐ 19 | 🐛 9 | 🌐 R | 📅 2026-09-18 - Shiny wrapper for Mol\*, a visualization toolkit of large scale molecular data.
...
* [plotomics](https://github.com/samuelbharti/plotomics) ⭐ 2 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-16 - GPU-accelerated bioinformatics htmlwidgets for Shiny, including volcano plots, heatmaps, embeddings, and oncoprints.
...
* [rayshader](https://github.com/tylermorganwall/rayshader) ⭐ 2,176 | 🐛 48 | 🌐 R | 📅 2026-09-07 - Create and visualize hillshaded maps from elevation matrices.
* [rayrender](https://github.com/tylermorganwall/rayrender) ⭐ 644 | 🐛 4 | 🌐 C++ | 📅 2026-09-18 - Build and raytrace 3D scenes.
...
* [teal](https://github.com/insightsengineering/teal) ⭐ 263 | 🐛 73 | 🌐 R | 📅 2026-09-17 - Interactive exploration framework for analyzing clinical trials data, provides a dynamic filtering facility and different data viewers.
* [surveydown](https://github.com/surveydown-dev/surveydown) ⭐ 182 | 🐛 17 | 🌐 R | 📅 2026-06-23 - Markdown-based programmable surveys using Quarto and Shiny, with skip logic, multiple question types, and database storage.
...
* [teal.slice](https://github.com/insightsengineering/teal.slice) ⭐ 12 | 🐛 38 | 🌐 R | 📅 2026-09-16 - Filter module for teal applications.
* [teal.data](https://github.com/insightsengineering/teal.data) ⭐ 11 | 🐛 21 | 🌐 R | 📅 2026-09-16 - Data model for teal applications.
* [teal.reporter](https://github.com/insightsengineering/teal.reporter) ⭐ 9 | 🐛 26 | 🌐 R | 📅 2026-09-16 - Reporting tools for Shiny modules.
...
* [teal.widgets](https://github.com/insightsengineering/teal.widgets) ⭐ 6 | 🐛 40 | 🌐 R | 📅 2026-09-18 - Shiny widgets for teal applications.
...
* [teal.picks](https://github.com/insightsengineering/teal.picks) ⭐ 4 | 🐛 27 | 🌐 R | 📅 2026-09-17 - Dataset and variable picker and merge module for teal applications.
* [VizModules](https://github.com/j-andrews7/VizModules) ⭐ 3 | 🐛 12 | 🌐 R | 📅 2026-09-17 - Flexible Shiny plotting modules for composing interactive visualization apps.
...
* [blockr.dplyr](https://github.com/BristolMyersSquibb/blockr.dplyr) ⭐ 1 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-17 - Interactive dplyr data transformation blocks for blockr.
...
* [pool](https://github.com/rstudio/pool) ⭐ 255 | 🐛 3 | 🌐 R | 📅 2026-09-16 - Database connection pooling in R.
...
* [brochure](https://github.com/ColinFay/brochure) ⭐ 109 | 🐛 1 | 🌐 R | 📅 2026-09-16 - Create natively multi-page Shiny applications to serve content from multiple endpoints. See [blog post](https://colinfay.me/post-request-shiny-app-brochure/) on POST requests support.
...
* [shinyOAuth](https://github.com/lukakoning/shinyOAuth) ⭐ 29 | 🐛 2 | 🌐 R | 📅 2026-09-20 - Provider-agnostic OAuth authentication for Shiny applications.
...
* [blastula](https://github.com/rstudio/blastula) ⭐ 572 | 🐛 107 | 🌐 R | 📅 2025-04-03 - Easily send HTML email messages from R.
...
* [googlesheets4](https://github.com/tidyverse/googlesheets4) ⭐ 377 | 🐛 37 | 🌐 R | 📅 2026-09-20 - R interface to Google Sheets via the Sheets API v4.
* [googledrive](https://github.com/tidyverse/googledrive) ⭐ 346 | 🐛 44 | 🌐 R | 📅 2026-09-20 - R API client for Google Drive.
...
* [rsconnect](https://github.com/rstudio/rsconnect) ⭐ 146 | 🐛 75 | 🌐 R | 📅 2026-09-18 - Deploy Shiny apps to shinyapps.io, or Posit Connect.
...
* [tinyshinyserver](https://github.com/lab1702/tinyshinyserver) ⭐ 21 | 🐛 0 | 🌐 R | 📅 2026-09-18 - Lightweight multi-app Shiny proxy with WebSocket support and automatic health monitoring.
...
* [webR](https://github.com/r-wasm/webr) ⭐ 1,093 | 🐛 92 | 🌐 TypeScript | 📅 2026-06-23 - A version of R compiled for the browser and Node.js using WebAssembly via Emscripten.
...
* [shinipsum](https://github.com/ThinkR-open/shinipsum) ⭐ 124 | 🐛 2 | 🌐 R | 📅 2026-09-17 - Lorem-Ipsum-like helpers for fast Shiny prototyping.
...
* [renv](https://github.com/rstudio/renv) ⭐ 1,163 | 🐛 219 | 🌐 R | 📅 2026-09-19 - Create isolated, portable, and reproducible environments for R projects.
...
* [shinychat](https://github.com/posit-dev/shinychat/tree/main/pkg-py) ⭐ 139 | 🐛 62 | 🌐 TypeScript | 📅 2026-09-18 - Chat UI component for Shiny for Python.
* [shinyrealtime](https://github.com/posit-dev/shinyrealtime) ⭐ 25 | 🐛 3 | 🌐 Python | 📅 2026-07-31 - Integrate OpenAI's Realtime API.

### Python - Table

* [great-tables](https://github.com/posit-dev/great-tables) ⭐ 2,836 | 🐛 110 | 🌐 Python | 📅 2026-09-20 - Create styled display tables in Python.
* [itables](https://github.com/mwouts/itables) ⭐ 976 | 🐛 44 | 🌐 Python | 📅 2026-09-18 - Display Pandas and Polars data frames as interactive DataTables that you can sort, paginate, scroll, and filter.
...
* [rsconnect-python](https://github.com/posit-dev/rsconnect-python) ⭐ 37 | 🐛 92 | 🌐 Python | 📅 2026-09-10 - CLI for interacting with and deploying to Posit Connect.
