...
[![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 501,751 | 🐛 105 | 📅 2026-08-21
...
* Inspired by: [awesome-react-components](https://github.com/brillout/awesome-react-components) ⭐ 48,309 | 🐛 87 | 📅 2026-01-26 and [awesome-rshiny](https://github.com/grabear/awesome-rshiny) ⭐ 870 | 🐛 7 | 🌐 R | 📅 2022-10-07.
...
* [querychat](https://github.com/posit-dev/querychat) ⭐ 211 | 🐛 28 | 🌐 Python | 📅 2026-08-31 - Filter and query data frames in Shiny using an LLM chat interface.
* [shinychat](https://github.com/posit-dev/shinychat) ⭐ 137 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-31 - Chat UI component for Shiny.
...
* [canvasXpress](https://github.com/neuhausi/canvasXpress) ⭐ 313 | 🐛 27 | 🌐 R | 📅 2026-08-31 - Interactive visualization for scientific and biomedical research using CanvasXpress.
...
* [myIO](https://github.com/mortonanalytics/myIO) ⭐ 7 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-31 - Composable D3 htmlwidget chart system.
...
* [maidr](https://github.com/xability/r-maidr) ⭐ 4 | 🐛 6 | 🌐 HTML | 📅 2026-08-31 - Multimodal access and interactive data representation with accessibility features.
...
* [toro](https://github.com/Epi-interactive-Ltd/toro) ⭐ 2 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-31 - Interactive and customizable maps using the MapLibre GL JS library.
...
* [igvShiny](https://github.com/gladkia/igvShiny) ⭐ 46 | 🐛 7 | 🌐 R | 📅 2026-08-31 - HTML widget for igv.js, a JavaScript library for embeddable genomic visualization.
...
* [rayrender](https://github.com/tylermorganwall/rayrender) ⭐ 644 | 🐛 4 | 🌐 C++ | 📅 2026-07-22 - Build and raytrace 3D scenes.
...
* [yonder](https://github.com/nteetor/yonder) ⭐ 136 | 🐛 27 | 🌐 R | 📅 2026-08-31 - A reactive web framework built on Shiny with Bootstrap 4.
...
* [blockr.core](https://github.com/BristolMyersSquibb/blockr.core) ⭐ 16 | 🐛 30 | 🌐 R | 📅 2026-08-31 - Graphical web framework for data manipulation and visualization using reusable, composable blocks.
...
* [VizModules](https://github.com/j-andrews7/VizModules) ⭐ 3 | 🐛 13 | 🌐 R | 📅 2026-08-31 - Flexible Shiny plotting modules for composing interactive visualization apps.
...
* [blockr.dock](https://github.com/BristolMyersSquibb/blockr.dock) ⭐ 0 | 🐛 30 | 🌐 R | 📅 2026-08-31 - A docking layout manager for blockr.
...
* [googlesheets4](https://github.com/tidyverse/googlesheets4) ⭐ 377 | 🐛 37 | 🌐 R | 📅 2026-08-31 - R interface to Google Sheets via the Sheets API v4.
* [googledrive](https://github.com/tidyverse/googledrive) ⭐ 346 | 🐛 41 | 🌐 R | 📅 2026-08-31 - R API client for Google Drive.
...
* [rsconnect](https://github.com/rstudio/rsconnect) ⭐ 145 | 🐛 74 | 🌐 R | 📅 2026-08-27 - Deploy Shiny apps to shinyapps.io, or Posit Connect.
...
* [shinyapps-package-dependencies](https://github.com/rstudio/shinyapps-package-dependencies) ⭐ 79 | 🐛 87 | 🌐 R | 📅 2026-04-24 - A collection of bash scripts that install system dependencies for R packages.
...
* [shinychat](https://github.com/posit-dev/shinychat/tree/main/pkg-py) ⭐ 137 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-31 - Chat UI component for Shiny for Python.
