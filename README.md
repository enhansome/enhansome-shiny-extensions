...
[![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 501,476 | 🐛 105 | 📅 2026-08-21
...
* Inspired by: [awesome-react-components](https://github.com/brillout/awesome-react-components) ⭐ 48,305 | 🐛 87 | 📅 2026-01-26 and [awesome-rshiny](https://github.com/grabear/awesome-rshiny) ⭐ 870 | 🐛 7 | 🌐 R | 📅 2022-10-07.
...
* [shinychat](https://github.com/posit-dev/shinychat) ⭐ 137 | 🐛 56 | 🌐 TypeScript | 📅 2026-08-28 - Chat UI component for Shiny.
...
* [gtsummary](https://github.com/ddsjoberg/gtsummary) ⭐ 1,208 | 🐛 18 | 🌐 R | 📅 2026-08-26 - Presentation-ready data summary and analytic result tables.
...
* [canvasXpress](https://github.com/neuhausi/canvasXpress) ⭐ 313 | 🐛 28 | 🌐 R | 📅 2026-08-28 - Interactive visualization for scientific and biomedical research using CanvasXpress.
...
* [myIO](https://github.com/mortonanalytics/myIO) ⭐ 7 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-29 - Composable D3 htmlwidget chart system.
...
* [toro](https://github.com/Epi-interactive-Ltd/toro) ⭐ 2 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-30 - Interactive and customizable maps using the MapLibre GL JS library.
...
* [igvShiny](https://github.com/gladkia/igvShiny) ⭐ 46 | 🐛 7 | 🌐 R | 📅 2026-08-30 - HTML widget for igv.js, a JavaScript library for embeddable genomic visualization.
...
* [yonder](https://github.com/nteetor/yonder) ⭐ 136 | 🐛 26 | 🌐 R | 📅 2026-08-30 - A reactive web framework built on Shiny with Bootstrap 4.
...
* [VizModules](https://github.com/j-andrews7/VizModules) ⭐ 3 | 🐛 13 | 🌐 R | 📅 2026-08-28 - Flexible Shiny plotting modules for composing interactive visualization apps.
...
* [blockr.dock](https://github.com/BristolMyersSquibb/blockr.dock) ⭐ 0 | 🐛 28 | 🌐 R | 📅 2026-08-28 - A docking layout manager for blockr.
...
* [googlesheets4](https://github.com/tidyverse/googlesheets4) ⭐ 377 | 🐛 37 | 🌐 R | 📅 2026-08-30 - R interface to Google Sheets via the Sheets API v4.
* [googledrive](https://github.com/tidyverse/googledrive) ⭐ 346 | 🐛 41 | 🌐 R | 📅 2026-08-30 - R API client for Google Drive.
...
* [box](https://github.com/klmr/box) ⭐ 976 | 🐛 71 | 🌐 R | 📅 2026-08-16 - Organize code into hierarchical, composable, reusable modules, to use across projects.
...
* [shinychat](https://github.com/posit-dev/shinychat/tree/main/pkg-py) ⭐ 137 | 🐛 56 | 🌐 TypeScript | 📅 2026-08-28 - Chat UI component for Shiny for Python.
