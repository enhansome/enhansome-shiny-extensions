...
[![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 496,985 | 🐛 102 | 📅 2026-06-30
...
* Inspired by: [awesome-react-components](https://github.com/brillout/awesome-react-components) ⭐ 48,213 | 🐛 78 | 📅 2026-01-26 and [awesome-rshiny](https://github.com/grabear/awesome-rshiny) ⭐ 869 | 🐛 7 | 🌐 R | 📅 2022-10-07.
...
* [shinyGovstyle](https://github.com/dfe-analytical-services/shinyGovstyle) ⭐ 52 | 🐛 27 | 🌐 R | 📅 2026-08-17 - Custom GOV.UK style inputs for Shiny.
...
* [flexdashboard](https://github.com/rstudio/flexdashboard) ⭐ 846 | 🐛 84 | 🌐 JavaScript | 📅 2026-06-26 - R Markdown format for flexible dashboards.
...
* [bs4Dashkit](https://github.com/PrigasG/bs4Dashkit) ⭐ 0 | 🐛 0 | 🌐 R | 📅 2026-08-17 - Branding, theme application, and navigation utilities for bs4Dash dashboards.
...
* [bslib](https://github.com/rstudio/bslib) ⭐ 567 | 🐛 203 | 🌐 SCSS | 📅 2026-08-13 - Tools for theming Shiny and R Markdown from R via Bootstrap (3 or 4) Sass.
...
* [glasstabs](https://github.com/PrigasG/glasstabs) ⭐ 2 | 🐛 0 | 🌐 R | 📅 2026-08-17 - Animated glass-style tabs and multi-select filter for Shiny.
...
* [conductor](https://github.com/etiennebacher/conductor) ⭐ 40 | 🐛 5 | 🌐 R | 📅 2026-08-17 - Create guided tours in Shiny apps using Shepherd.js.
...
* [shinychat](https://github.com/posit-dev/shinychat) ⭐ 136 | 🐛 60 | 🌐 TypeScript | 📅 2026-08-17 - Chat UI component for Shiny.
...
* [gt](https://github.com/rstudio/gt) ⭐ 2,162 | 🐛 319 | 🌐 R | 📅 2026-08-15 - Generate information-rich, publication-quality tables.
...
* [ggiraph](https://github.com/davidgohel/ggiraph) ⭐ 876 | 🐛 11 | 🌐 R | 📅 2026-08-14 - HTML widget that makes ggplot2 graphics interactive. Select graphical elements, add tooltips, animations, and JavaScript actions to the graphics.
...
* [canvasXpress](https://github.com/neuhausi/canvasXpress) ⭐ 313 | 🐛 29 | 🌐 R | 📅 2026-08-17 - Interactive visualization for scientific and biomedical research using CanvasXpress.
...
* [maidr](https://github.com/xability/r-maidr) ⭐ 4 | 🐛 6 | 🌐 HTML | 📅 2026-08-17 - Multimodal access and interactive data representation with accessibility features.
...
* [igvShiny](https://github.com/gladkia/igvShiny) ⭐ 43 | 🐛 9 | 🌐 R | 📅 2026-08-17 - HTML widget for igv.js, a JavaScript library for embeddable genomic visualization.
...
* [yonder](https://github.com/nteetor/yonder) ⭐ 136 | 🐛 24 | 🌐 R | 📅 2026-08-17 - A reactive web framework built on Shiny with Bootstrap 4.
...
* [periscope2](https://github.com/Aggregate-Genius/periscope2) ⭐ 9 | 🐛 1 | 🌐 R | 📅 2026-08-17 - Enterprise streamlined Shiny application framework using bs4Dash.
...
* [teal.modules.clinical](https://github.com/insightsengineering/teal.modules.clinical) ⭐ 42 | 🐛 108 | 🌐 R | 📅 2026-08-17 - A set of teal modules for standard clinical outputs.
* [mwshiny](https://github.com/delosh653/mwshiny) ⭐ 25 | 🐛 2 | 🌐 R | 📅 2020-06-08 - Run a Shiny app across multiple connected browser windows.
* [teal.modules.general](https://github.com/insightsengineering/teal.modules.general) ⭐ 16 | 🐛 41 | 🌐 R | 📅 2026-08-17 - General modules for teal applications.
...
* [VizModules](https://github.com/j-andrews7/VizModules) ⭐ 3 | 🐛 12 | 🌐 R | 📅 2026-08-17 - Flexible Shiny plotting modules for composing interactive visualization apps.
...
* [blockr.dock](https://github.com/BristolMyersSquibb/blockr.dock) ⭐ 0 | 🐛 26 | 🌐 R | 📅 2026-08-15 - A docking layout manager for blockr.
...
* [googlesheets4](https://github.com/tidyverse/googlesheets4) ⭐ 375 | 🐛 37 | 🌐 R | 📅 2026-08-17 - R interface to Google Sheets via the Sheets API v4.
* [googledrive](https://github.com/tidyverse/googledrive) ⭐ 345 | 🐛 41 | 🌐 R | 📅 2026-08-17 - R API client for Google Drive.
...
* [rsconnect](https://github.com/rstudio/rsconnect) ⭐ 145 | 🐛 72 | 🌐 R | 📅 2026-08-17 - Deploy Shiny apps to shinyapps.io, or Posit Connect.
...
* [box](https://github.com/klmr/box) ⭐ 972 | 🐛 71 | 🌐 R | 📅 2026-08-16 - Organize code into hierarchical, composable, reusable modules, to use across projects.
...
* [jsplyr](https://github.com/r-world-devs/jsplyr) ⭐ 22 | 🐛 9 | 🌐 R | 📅 2026-07-17 - Dplyr backend for Shiny that lazily translates data wrangling verbs into client-side JavaScript and returns results asynchronously as promises.
...
* [renv](https://github.com/rstudio/renv) ⭐ 1,159 | 🐛 217 | 🌐 R | 📅 2026-08-17 - Create isolated, portable, and reproducible environments for R projects.
...
* [shinychat](https://github.com/posit-dev/shinychat/tree/main/pkg-py) ⭐ 136 | 🐛 60 | 🌐 TypeScript | 📅 2026-08-17 - Chat UI component for Shiny for Python.
...
* [rsconnect-python](https://github.com/posit-dev/rsconnect-python) ⭐ 37 | 🐛 95 | 🌐 Python | 📅 2026-08-17 - CLI for interacting with and deploying to Posit Connect.

### Python - Persistent Data Storage

* [pins-python](https://github.com/rstudio/pins-python) ⭐ 58 | 🐛 66 | 🌐 Python | 📅 2026-07-14 - Publish data, models, and other Python objects for sharing across projects and with colleagues.
