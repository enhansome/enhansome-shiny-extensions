...
[![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 504,540 | 🐛 106 | 📅 2026-09-02
...
* Inspired by: [awesome-react-components](https://github.com/brillout/awesome-react-components) ⭐ 48,368 | 🐛 91 | 📅 2026-01-26 and [awesome-rshiny](https://github.com/grabear/awesome-rshiny) ⭐ 870 | 🐛 7 | 🌐 R | 📅 2022-10-07.
...
* [shinyGovstyle](https://github.com/dfe-analytical-services/shinyGovstyle) ⭐ 52 | 🐛 22 | 🌐 R | 📅 2026-09-09 - Custom GOV.UK style inputs for Shiny.
* [shiny.blueprint](https://github.com/Appsilon/shiny.blueprint) ⭐ 48 | 🐛 28 | 🌐 R | 📅 2026-09-09 - Palantir's Blueprint for Shiny apps.
...
* [shinyglass](https://github.com/ericrayanderson/shinyglass) ⭐ 2 | 🐛 0 | 🌐 R | 📅 2026-09-10 - Liquid Glass design themes for Shiny, adding translucent surfaces, backdrop blur, and system typography to Bootstrap components via bslib.
...
* [querychat](https://github.com/posit-dev/querychat) ⭐ 211 | 🐛 31 | 🌐 Python | 📅 2026-09-10 - Filter and query data frames in Shiny using an LLM chat interface.
* [shinychat](https://github.com/posit-dev/shinychat) ⭐ 137 | 🐛 60 | 🌐 TypeScript | 📅 2026-09-09 - Chat UI component for Shiny.
...
* [shinygenui](https://github.com/nanxstats/shinygenui) ⭐ 0 | 🐛 0 | 🌐 R | 📅 2026-09-10 - Build and update Shiny interfaces through conversations with a large language model.
...
* [canvasXpress](https://github.com/neuhausi/canvasXpress) ⭐ 313 | 🐛 28 | 🌐 R | 📅 2026-09-09 - Interactive visualization for scientific and biomedical research using CanvasXpress.
...
* [d3po](https://github.com/pachadotdev/d3po) ⭐ 51 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-04 - Fast and beautiful interactive visualization for R Markdown and Shiny. Acts as intermediate layer between Shiny and D3 by providing templates.
...
* [DiagrammeR](https://github.com/rich-iannone/DiagrammeR) ⭐ 1,741 | 🐛 172 | 🌐 R | 📅 2026-04-27 - Diagram, graph, and network visualization based on D3.js, viz.js, and mermaid.js.
...
* [leaflet.extras](https://github.com/trafficonese/leaflet.extras) ⭐ 223 | 🐛 23 | 🌐 R | 📅 2026-09-09 - Extra functionality for the leaflet package.
...
* [leaflegend](https://github.com/tomroh/leaflegend) ⭐ 38 | 🐛 2 | 🌐 R | 📅 2026-07-23 - Custom legends and symbols for leaflet maps.
...
* [threeBrain](https://github.com/dipterix/threeBrain) ⭐ 52 | 🐛 0 | 🌐 R | 📅 2026-09-09 - Advanced 3D brain visualization as an htmlwidget.
...
* [igvShiny](https://github.com/gladkia/igvShiny) ⭐ 46 | 🐛 6 | 🌐 R | 📅 2026-09-09 - HTML widget for igv.js, a JavaScript library for embeddable genomic visualization.
...
* [shiny.molstar](https://github.com/Appsilon/shiny.molstar) ⭐ 19 | 🐛 9 | 🌐 R | 📅 2026-09-09 - Shiny wrapper for Mol\*, a visualization toolkit of large scale molecular data.
...
* [rayrender](https://github.com/tylermorganwall/rayrender) ⭐ 644 | 🐛 4 | 🌐 C++ | 📅 2026-09-09 - Build and raytrace 3D scenes.
...
* [teal](https://github.com/insightsengineering/teal) ⭐ 263 | 🐛 75 | 🌐 R | 📅 2026-09-09 - Interactive exploration framework for analyzing clinical trials data, provides a dynamic filtering facility and different data viewers.
...
* [teal.code](https://github.com/insightsengineering/teal.code) ⭐ 12 | 🐛 19 | 🌐 R | 📅 2026-09-09 - Code storage and execution class for teal applications.
* [teal.slice](https://github.com/insightsengineering/teal.slice) ⭐ 12 | 🐛 37 | 🌐 R | 📅 2026-09-09 - Filter module for teal applications.
* [teal.data](https://github.com/insightsengineering/teal.data) ⭐ 11 | 🐛 21 | 🌐 R | 📅 2026-09-09 - Data model for teal applications.
* [teal.reporter](https://github.com/insightsengineering/teal.reporter) ⭐ 9 | 🐛 27 | 🌐 R | 📅 2026-09-09 - Reporting tools for Shiny modules.
...
* [teal.logger](https://github.com/insightsengineering/teal.logger) ⭐ 7 | 🐛 7 | 🌐 R | 📅 2026-09-09 - Logging setup for the teal family of packages.
...
* [teal.widgets](https://github.com/insightsengineering/teal.widgets) ⭐ 6 | 🐛 38 | 🌐 R | 📅 2026-09-09 - Shiny widgets for teal applications.
...
* [teal.picks](https://github.com/insightsengineering/teal.picks) ⭐ 4 | 🐛 29 | 🌐 R | 📅 2026-09-09 - Dataset and variable picker and merge module for teal applications.
* [VizModules](https://github.com/j-andrews7/VizModules) ⭐ 3 | 🐛 14 | 🌐 R | 📅 2026-09-09 - Flexible Shiny plotting modules for composing interactive visualization apps.
...
* [blockr.dag](https://github.com/BristolMyersSquibb/blockr.dag) ⭐ 0 | 🐛 22 | 🌐 R | 📅 2026-09-08 - A directed acyclic graph extension for blockr.
* [blockr.dock](https://github.com/BristolMyersSquibb/blockr.dock) ⭐ 0 | 🐛 29 | 🌐 R | 📅 2026-09-09 - A docking layout manager for blockr.
...
* [shinyOAuth](https://github.com/lukakoning/shinyOAuth) ⭐ 28 | 🐛 2 | 🌐 R | 📅 2026-09-09 - Provider-agnostic OAuth authentication for Shiny applications.
...
* [googlesheets4](https://github.com/tidyverse/googlesheets4) ⭐ 377 | 🐛 37 | 🌐 R | 📅 2026-09-09 - R interface to Google Sheets via the Sheets API v4.
* [googledrive](https://github.com/tidyverse/googledrive) ⭐ 346 | 🐛 41 | 🌐 R | 📅 2026-09-09 - R API client for Google Drive.
...
* [rsconnect](https://github.com/rstudio/rsconnect) ⭐ 146 | 🐛 80 | 🌐 R | 📅 2026-09-09 - Deploy Shiny apps to shinyapps.io, or Posit Connect.
...
* [shinychat](https://github.com/posit-dev/shinychat/tree/main/pkg-py) ⭐ 137 | 🐛 60 | 🌐 TypeScript | 📅 2026-09-09 - Chat UI component for Shiny for Python.
* [shinyrealtime](https://github.com/posit-dev/shinyrealtime) ⭐ 25 | 🐛 3 | 🌐 Python | 📅 2026-07-31 - Integrate OpenAI's Realtime API.

### Python - Table

* [great-tables](https://github.com/posit-dev/great-tables) ⭐ 2,726 | 🐛 106 | 🌐 Python | 📅 2026-09-08 - Create styled display tables in Python.
* [itables](https://github.com/mwouts/itables) ⭐ 976 | 🐛 42 | 🌐 Python | 📅 2026-09-07 - Display Pandas and Polars data frames as interactive DataTables that you can sort, paginate, scroll, and filter.
...
* [rsconnect-python](https://github.com/posit-dev/rsconnect-python) ⭐ 37 | 🐛 92 | 🌐 Python | 📅 2026-09-09 - CLI for interacting with and deploying to Posit Connect.
