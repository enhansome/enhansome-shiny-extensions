...
[![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 498,230 | 🐛 105 | 📅 2026-08-18
...
* Inspired by: [awesome-react-components](https://github.com/brillout/awesome-react-components) ⭐ 48,238 | 🐛 81 | 📅 2026-01-26 and [awesome-rshiny](https://github.com/grabear/awesome-rshiny) ⭐ 870 | 🐛 7 | 🌐 R | 📅 2022-10-07.
...
* [shinyglass](https://github.com/ericrayanderson/shinyglass) ⭐ 1 | 🐛 1 | 🌐 R | 📅 2026-08-20 - Liquid Glass design themes for Shiny, adding translucent surfaces, backdrop blur, and system typography to Bootstrap components via bslib.
...
* [bslib](https://github.com/rstudio/bslib) ⭐ 568 | 🐛 206 | 🌐 SCSS | 📅 2026-08-20 - Tools for theming Shiny and R Markdown from R via Bootstrap (3 or 4) Sass.
...
* [shinychat](https://github.com/posit-dev/shinychat) ⭐ 136 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-20 - Chat UI component for Shiny.
...
* [gt](https://github.com/rstudio/gt) ⭐ 2,161 | 🐛 318 | 🌐 R | 📅 2026-08-19 - Generate information-rich, publication-quality tables.
* [gtsummary](https://github.com/ddsjoberg/gtsummary) ⭐ 1,207 | 🐛 17 | 🌐 R | 📅 2026-08-20 - Presentation-ready data summary and analytic result tables.
...
* [esquisse](https://github.com/dreamRs/esquisse) ⭐ 1,858 | 🐛 53 | 🌐 R | 📅 2025-02-21 - Drag and drop inputs and visual builder for ggplot2.
...
* [canvasXpress](https://github.com/neuhausi/canvasXpress) ⭐ 313 | 🐛 27 | 🌐 R | 📅 2026-08-20 - Interactive visualization for scientific and biomedical research using CanvasXpress.
...
* [maidr](https://github.com/xability/r-maidr) ⭐ 4 | 🐛 10 | 🌐 HTML | 📅 2026-08-20 - Multimodal access and interactive data representation with accessibility features.
...
* [timevis](https://github.com/daattali/timevis) ⭐ 682 | 🐛 4 | 🌐 R | 📅 2024-08-18 - Interactive timeline visualizations based on vis.js.
...
* [mapgl](https://github.com/walkerke/mapgl) ⭐ 171 | 🐛 25 | 🌐 R | 📅 2026-08-20 - Interactive maps using Mapbox GL JS and MapLibre GL JS.
...
* [igvShiny](https://github.com/gladkia/igvShiny) ⭐ 45 | 🐛 9 | 🌐 R | 📅 2026-08-20 - HTML widget for igv.js, a JavaScript library for embeddable genomic visualization.
...
* [blockr.core](https://github.com/BristolMyersSquibb/blockr.core) ⭐ 16 | 🐛 25 | 🌐 R | 📅 2026-08-20 - Graphical web framework for data manipulation and visualization using reusable, composable blocks.
...
* [periscope2](https://github.com/Aggregate-Genius/periscope2) ⭐ 9 | 🐛 0 | 🌐 R | 📅 2026-08-20 - Enterprise streamlined Shiny application framework using bs4Dash.
...
* [VizModules](https://github.com/j-andrews7/VizModules) ⭐ 3 | 🐛 13 | 🌐 R | 📅 2026-08-20 - Flexible Shiny plotting modules for composing interactive visualization apps.
...
* [blockr.dock](https://github.com/BristolMyersSquibb/blockr.dock) ⭐ 0 | 🐛 27 | 🌐 R | 📅 2026-08-20 - A docking layout manager for blockr.
* [blockr.session](https://github.com/BristolMyersSquibb/blockr.session) ⭐ 0 | 🐛 7 | 🌐 R | 📅 2026-08-20 - Persist, restore, share, and manage blockr boards with pins-backed storage, including Posit Connect user accounts and version history.
...
* [blastula](https://github.com/rstudio/blastula) ⭐ 576 | 🐛 107 | 🌐 R | 📅 2025-04-03 - Easily send HTML email messages from R.
...
* [googlesheets4](https://github.com/tidyverse/googlesheets4) ⭐ 375 | 🐛 37 | 🌐 R | 📅 2026-08-20 - R interface to Google Sheets via the Sheets API v4.
* [googledrive](https://github.com/tidyverse/googledrive) ⭐ 345 | 🐛 41 | 🌐 R | 📅 2026-08-20 - R API client for Google Drive.
...
* [webR](https://github.com/r-wasm/webr) ⭐ 1,089 | 🐛 91 | 🌐 TypeScript | 📅 2026-06-23 - A version of R compiled for the browser and Node.js using WebAssembly via Emscripten.
...
* [renv](https://github.com/rstudio/renv) ⭐ 1,160 | 🐛 220 | 🌐 R | 📅 2026-08-20 - Create isolated, portable, and reproducible environments for R projects.
...
* [shinychat](https://github.com/posit-dev/shinychat/tree/main/pkg-py) ⭐ 136 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-20 - Chat UI component for Shiny for Python.
* [shinyrealtime](https://github.com/posit-dev/shinyrealtime) ⭐ 25 | 🐛 3 | 🌐 Python | 📅 2026-07-31 - Integrate OpenAI's Realtime API.

### Python - Table

* [great-tables](https://github.com/posit-dev/great-tables) ⭐ 2,719 | 🐛 106 | 🌐 Python | 📅 2026-08-20 - Create styled display tables in Python.
* [itables](https://github.com/mwouts/itables) ⭐ 972 | 🐛 40 | 🌐 Python | 📅 2026-08-14 - Display Pandas and Polars data frames as interactive DataTables that you can sort, paginate, scroll, and filter.
...
* [rsconnect-python](https://github.com/posit-dev/rsconnect-python) ⭐ 37 | 🐛 95 | 🌐 Python | 📅 2026-08-20 - CLI for interacting with and deploying to Posit Connect.
